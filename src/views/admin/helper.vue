  ...
  <div class="page">
    <div class="search">
      ...
      <div class="item">
        ...
        <el-button type="primary" class="button" @click="dialogFormVisible=true">新添督导</el-button>
          ...
          <el-form label-position="top" label-width="80px" size="medium " :model="form" inline="true" style="text-align: center;margin: 20px">
            <el-tabs v-model="activeName" @tab-click="handleClick">
              ...
              <el-tab-pane label="工作信息" name="second">
                ...
                <el-form-item label=""><div style="text-align: left">督导资质</div>
                  <el-select v-model="form.name" style="width: 300px" placeholder="请选择督导资质">
                    <el-option label="区域一" value="shanghai" />
                    <el-option label="区域二" value="beijing" />
                  </el-select>
                </el-form-item>
                <el-form-item label=""><div style="text-align: left">资质编号</div>
                  <el-input v-model="form.type" style="width: 300px" placeholder="请输入资质编号" />
                </el-form-item>
              </el-tab-pane>
            </el-tabs>
          </el-form>
